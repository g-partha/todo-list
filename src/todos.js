...
export function createTodo(todoTitle, todoDescription, todoProject, todoDueDate, todoPriority, todoCompletionStatus){
    todosList.push(new Todo(todoTitle, todoDescription, todoProject, todoDueDate, todoPriority, todoCompletionStatus));
...
export function updateTodo(uniqueId, updatedTitle, updatedDescription, updatedProjectID,
    updatedDueDate, updatedPriority, updatedCompletionStatus){
        const indexOfItem = todosList.findIndex((item) => item.id === uniqueId);
        if(indexOfItem !== -1){
