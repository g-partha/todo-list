import {createTodo, getTodo, getTodosByProject, deleteTodo, getTodosList, recoverTodosFromLocalStorage, updateTodo} from "./todos";
...
function testProjectFunctions(){
    ...
    updateProject("100", "updated title", "this is the updated project description");
    consoleLogTodosAndProjects();
}
...
function testTodoFunctions(){
    ...
    createTestTodo("Do homework", "I'm doing homework", "0000", "08-08-1997", "low priority", "completed");
    createTestTodo("Buy potato", "I have to buy round potatoes", "0000", "08-08-1997", "high priority", "not completed");
    createTestTodo("Boil the milk", "It is in the jug", "0000", "08-08-1997", "medium priority", "completed");
    consoleLogTodosAndProjects();
    ...
    updateTodo("9002", "nt", "this is the updated todo description", "0000", "07-01-1997", "P1", "Completed");
    consoleLogTodosAndProjects();
